...
export class Modal extends Component<IModalData> {
  ...
  constructor(events: EventEmitter) {
    ...
    this._content = this.container.querySelector('.modal-content') as HTMLElement;
    if (!this._content) {
      throw new Error('Не найдено');
    }

    this._closeButton = this.container.querySelector('.modal-close-button') as HTMLButtonElement;
