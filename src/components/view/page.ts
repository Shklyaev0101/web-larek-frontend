...
export class Page extends Component<IPage> {
  ...
  constructor(container: HTMLElement, events: EventEmitter) {
    ...
    this._wrapper = this.container.querySelector('.page__wrapper') as HTMLElement;
    this._basket = this.container.querySelector('.header__basket') as HTMLElement;
  ...
  set counter(value: number) {
    ...
    this.toggleClass(this._counter, 'header__basket-counter--visible', value > 0); // Показать или скрыть счётчик
  }
