...
Класс управляет интерфейсом корзины: он показывает список товаров, считает итоговую сумму и включает/выключает кнопку оформления заказа в зависимости от содержимого.<br>
